...
- [1. Foundational Paradigm: Logical vs. Physical Isolation](#foundational-paradigm)
- [2. Core Architectural Pillars](#core-architectural-pillars)
- [3. Core Compiler Principles](#core-compiler-principles)
- [4. Compiler Architecture & The Clay AST](#compiler-architecture--the-clay-ast)
- [5. Declarative Topology Recipe Specification (YAML)](#declarative-topology-recipe-specification-yaml)
- [6. Dynamic Reconfiguration & Live Morphing Operations](#dynamic-reconfiguration--live-morphing-operations)
- [7. Real-Time Context Database (CDB) Implementation](#real-time-context-database-cdb-implementation)
- [8. Persistent Storage Adapter (PSA) Implementation](#persistent-storage-adapter-psa-implementation)
- [9. Conditional Compliance Framework](#conditional-compliance-framework)
- [10. Memory Model & Data Lifetime Guarantees](#memory-model--data-lifetime-guarantees)
- [11. Modularity & The Brick Catalog](#modularity--the-brick-catalog)
- [12. Communication Transport Taxonomy & Swapping](#communication-transport-taxonomy--swapping)
- [13. Compiler Pass Specification](#compiler-pass-specification)
- [14. Error Reporting Contract](#error-reporting-contract)
- [15. Recipe Schema Formalization](#recipe-schema-formalization)
- [16. Multi-Language Target Support](#multi-language-target-support)
- [17. Topology Extension & Feature Integration](#topology-extension--feature-integration)
- [18. References](#references)
- [19. Legend](#legend)

---

<a id="foundational-paradigm"></a>
